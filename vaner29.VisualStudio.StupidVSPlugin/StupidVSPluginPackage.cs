...
namespace vaner29.VisualStudio.StupidVSPlugin
{
    ...
    public sealed class StupidVSPluginPackage : AsyncPackage
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="StupidVSPluginPackage"/> class.
        /// </summary>
        public StupidVSPluginPackage()
        {
        ...
        protected override async System.Threading.Tasks.Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            await EventCatcher.Instance.InitAsync(this,
